module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c3 = function(node) {return {document:node}},
        peg$c4 = " ",
        peg$c5 = { type: "literal", value: " ", description: "\" \"" },
        peg$c6 = function(c) {return "f1";},
        peg$c7 = function(c) {return c.join("");},
        peg$c8 = /^[a-zA-Z.]/,
        peg$c9 = { type: "class", value: "[a-zA-Z.]", description: "[a-zA-Z.]" },
        peg$c10 = { type: "other", description: "Whitespace" },
        peg$c11 = void 0,
        peg$c12 = function(nodeHead, attributes) { 
        ...
        peg$c15 = function(node, children) {     
              if (children) node["children"]=children; 
              return node; 
        },
        peg$c16 = function(attrs) {return attrs;},
        peg$c17 = { type: "other", description: "Attribute" },
        peg$c18 = "=",
        peg$c19 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c20 = function(name, attr) { var o = {};o[name]=attr;return o;},
        peg$c21 = { type: "other", description: "Parameter" },
        peg$c22 = function(attr) { return attr },
        peg$c23 = function(attr) {return attr},
        peg$c24 = { type: "other", description: "Word" },
        peg$c25 = /^[a-z0-9,.\/\\$+*_\-<>:(')]/i,
        peg$c26 = { type: "class", value: "[a-z0-9,.\\/\\\\$+*_\\-<>:(')]i", description: "[a-z0-9,.\\/\\\\$+*_\\-<>:(')]i" },
        peg$c27 = function(e, f) {return (e)?([e + f.join("")]):f},
        ...
        peg$c47 = function(c) {return {f:c};},
        peg$c48 = function(c) {return {comment:c};},
        peg$c49 = /^[ \t]/,
        ...
        peg$c58 = function() { indent = indentStack.pop(); },
        peg$c59 = function(i) { return i.length > indent.length; },
        peg$c60 = function(i) { indentStack.push(indent); indent = i.join(""); pos = offset; },
        peg$c61 = function(i) { indentStack.push(indent); indent = i.join(""); peg$currPos = offset(); },
    ...
    function peg$parseNode() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            s5 = peg$parseAttributeOrParameters();
            if (s5 !== peg$FAILED) {
              peg$reportedPos = s2;
              s3 = peg$c12(s4, s5);
              s2 = s3;
    ...
    function peg$parseAttributeOrParameters() {
      var s0, s1, s2, s3;
    ...
    function peg$parseParameter() {
      ...
      s0 = peg$currPos;
      s1 = peg$currPos;
      s2 = peg$parseLiteralOrStringOrCode();
      if (s2 !== peg$FAILED) {
        peg$reportedPos = s1;
        s2 = peg$c22(s2);
      }
    ...
    function peg$parseCommentCharacters() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parseCommentCharacter();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parseCommentCharacter();
